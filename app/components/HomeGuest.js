    ...
    switch (action.type) {
      case "usernameImmediately":
        ...
        if (
          ...
          draft.username.hasErrors = true
          draft.username.message = "No special characters allowed"
        }
        return
      case "usernameAfterDelay":
        if (draft.username.value.length < 3) {
          draft.username.hasErrors = true
          draft.username.message = "Username must be least 3 character."
        }
      ...
      case "passwordAfterDelay":
        if (draft.password.value.length < 12) {
          draft.password.hasErrors = true
          draft.password.message = "Password must be least 12 characters."
        }
        return
      case "submitForm":
        if (
